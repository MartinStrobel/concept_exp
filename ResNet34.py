# Taken from https://www.kaggle.com/meaninglesslives/pretrained-resnet34-in-keras
from keras_applications.imagenet_utils import _obtain_input_shape
from tensorflow.keras.layers import BatchNormalization, ZeroPadding2D, Activation, Add
